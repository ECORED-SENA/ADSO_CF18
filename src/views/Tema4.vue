...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    #Fachada.pRelative
      ...
      .row.mb-5
        .col-lg-6
          p A continuación, se muestra una implementación en código Java de cada uno de los elementos requeridos para la implementación del patrón fachada en un ejemplo sencillo. En este ejemplo el cliente quiere realizar una compra, pero este proceso involucra acciones por parte de tres diferentes subsistemas: subsistema de compras que verifica la viabilidad de la tarjeta para el pago, el subsistema de inventario que verifica si hay productos en stock y el subsistema de envíos. 
          .cajon.color-acento-contenido.p-4
            p.mb-0 Para disminuir la complejidad, de la cual no debería ocuparse el cliente, se creará una fachada que encapsula las acciones de todos los subsistemas involucrados y proveer una interfaz simple con la que el cliente podrá interactuar más fácilmente.
          ...
          .row.justify-content-around.align-items-center
            ...
            .col
              .row.justify-content-between.align-items-center
                ...
                .col-sm-auto
                  a.boton.color-acento-contenido(href="https://gitlab.com/jonathanga/patron-fachada-en-java/-/tree/master" target="_blank")
                    span Ver
                    i.fas.fa-link
            ...
            .col
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0
                  ...
                  p.text-white Para obtener una copia completa del proyecto, para su verificación, usted puede consultar el repositorio público disponible en:
                .col-sm-auto
                  a.boton.color-acento-contenido(href="https://gitlab.com/jonathanga/patron-delegate/-/tree/master" target="_blank")
                    span Ver
                    i.fas.fa-link
