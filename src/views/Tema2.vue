...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row
      .col-lg-6
        p Los patrones de diseño comportamentales se centran en definir la manera en que los objetos interactúan entre ellos, por medio de mensajes. Son tres los tipos de patrones comportamentales: estrategia, comando e iterador.
        .cajon.color-acento-contenido.p-4
          p.mb-0 Explore el siguiente recurso y conozca los aspectos más relevantes relacionados con patrones comportamentales:
    ...
    #Comando.pRelative
      .backtoTop
        a.indicador__container(@click="goToElement('Patrones')" @mouseover="mostrarIndicador = false")
          ...
          .indicador--click(v-if="mostrarIndicador")
      h3 Comando
      p El patrón comando permite aislar los objetos que realizan una petición de los objetos concretos encargados de recibir y realizar dicha acción, esto permite entre otras cosas, que las peticiones puedan ser enviadas a varios receptores y si se maneja el estado de las solicitudes, controla acciones de tipo 
        em Undo 
        | y 
        em Redo.
      .row.align-items-center
        .col-lg-6
          p El patrón comando necesita la implementación de varios elementos:
          ul.lista-ul
            li
              i.fas.fa-layer-group.cs
              p.mb-0 <b>Comando:</b> clase que sirve de puente entre el cliente y los receptores.
            li
              i.fas.fa-layer-group.cs
              p.mb-0 <em><b>Invoker:</b> </em> elemento usado por los clientes y que le solicita al comando llevar a cabo una acción.
            li
              i.fas.fa-layer-group.cs
              p.mb-0 <b>Cliente:</b> invoca la ejecución de las acciones desde el 
                em Invoker.
            li
              i.fas.fa-layer-group.cs
              p.mb-0 <b>IComando:</b> interfaz donde se especifican las operaciones a ejecutar.
            li
              i.fas.fa-layer-group.cs
              p.mb-0 <b>Receptor:</b> clase que realiza la acción.
            li
              i.fas.fa-layer-group.cs
              p.mb-0 <b>Ejecutar:</b> operación que necesita ser llevada a cabo.
          .cajon.color-acento-contenido.p-4
            p.mb-0 
              p.mb-0 <b>Ejemplo:</b> una persona (Cliente) quiere hacer uso del televisor y hace todas las solicitudes de servicios por medio del control remoto (
                em Invoker
                | ). El control remoto se comunica con una interfaz encargada de responder solicitudes de cada comando, que el usuario puede hacer como, por ejemplo, prender televisor, apagar televisor, subir volumen, etc. Cada comando realiza una acción particular sobre el televisor (Receptor).
        .col-lg-6.order-first.order-lg-last(data-aos='fade-left')
          figure
      ...
      .row.mb-4.traslapeTop
        .col-lg-3.col-md-6.ofVisible(data-aos='flip-left')
          ...
          .p-4.fblanco.boxShadow.h430px
            .py-4
            p.text-center En este patrón se reconocen los enumeradores y los iteradores. Los enumeradores se establecen para conocer el siguiente elemento de la estructura y los iteradores corresponden a un mecanismo para recorrer la estructura, de acuerdo con su secuencia, de inicio a fin.
        .col-lg-3.col-md-6.ofVisible(data-aos='flip-left')
          figure
